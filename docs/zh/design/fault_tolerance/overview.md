...
故障按严重程度分为 7 个等级，由原始故障类型映射而来（[fault_types.py](https://gitcode.com/Ascend/MindIE-Motor/blob/v3.1.0/motor/controller/fault_tolerance/fault_types.py)）：
...
**NodeManager 侧（[engine_manager.py](https://gitcode.com/Ascend/MindIE-Motor/blob/v3.1.0/motor/node_manager/core/engine_manager.py)）**：
...
**Controller 侧（[instance_assembler.py](https://gitcode.com/Ascend/MindIE-Motor/blob/v3.1.0/motor/controller/core/instance_assembler.py)）**：
...
- **策略代码**：[scale_p2d.py](https://gitcode.com/Ascend/MindIE-Motor/blob/v3.1.0/motor/controller/fault_tolerance/strategy/scale_p2d.py)

### 策略路由

[strategy.py](https://gitcode.com/Ascend/MindIE-Motor/blob/v3.1.0/motor/controller/fault_tolerance/strategy/strategy.py) 中的策略映射：
...
- **策略代码**：[token_reinference.py](https://gitcode.com/Ascend/MindIE-Motor/blob/v3.1.0/motor/controller/fault_tolerance/strategy/token_reinference.py)
