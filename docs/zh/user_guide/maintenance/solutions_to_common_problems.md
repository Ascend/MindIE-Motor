...
**解决方案**
本仓库部署模板默认使用 `seccompProfile.type: Unconfined`，可避免该问题。若需更高安全等级或使用 RuntimeDefault，请参考 [Pod 权限说明](https://gitcode.com/Ascend/MindIE-Motor/blob/v3.1.0/examples/features/pod_permission_guide/README.md)。
