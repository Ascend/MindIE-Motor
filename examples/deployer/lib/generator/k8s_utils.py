...
def create_motor_config_configmap(job_id, user_config=None, effective_deploy_mode=None):
    ...
    apply_configmap(
        ...
        f"--from-file=patch_apply_shuffle_safetensors.py=./{C.PATCH_ROOT_PATH}/patch_apply_shuffle_safetensors.py "
        f"--from-file=vllm_shuffle_load_config.patch=./{C.PATCH_ROOT_PATH}/vllm_shuffle_load_config.patch "
        f"--from-file=vllm_shuffle_default_loader.patch=./{C.PATCH_ROOT_PATH}/vllm_shuffle_default_loader.patch "
        f"--from-file=vllm_shuffle_weight_utils.patch=./{C.PATCH_ROOT_PATH}/vllm_shuffle_weight_utils.patch "
