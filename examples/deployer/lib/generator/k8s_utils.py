...
def create_motor_config_configmap(job_id, user_config=None, effective_deploy_mode=None):
    ...
    apply_configmap(
        ...
        f"--from-file=patch_apply_shuffle_safetensors.py=../../patch/patch_apply_shuffle_safetensors.py "
        f"--from-file=vllm_shuffle_load_config.patch=../../patch/vllm_shuffle_load_config.patch "
        f"--from-file=vllm_shuffle_default_loader.patch=../../patch/vllm_shuffle_default_loader.patch "
        f"--from-file=vllm_shuffle_weight_utils.patch=../../patch/vllm_shuffle_weight_utils.patch "
