...
from lib.utils import apply_node_selector_override, load_yaml, resolve_workload_image, write_yaml, logger
...
def generate_yaml_kv_conductor(input_yaml, output_file, user_config, kv_conductor_config):
    ...
    container[C.IMAGE] = resolve_workload_image(user_config, user_config.get(C.KV_CONDUCTOR_CONFIG))
